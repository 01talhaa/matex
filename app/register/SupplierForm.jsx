...
const SupplierForm = () => {
  ...
  const handleFileChange = (e) => {
    ...
    setFormData({
      ...formData,
      documents: files,
      documentPreviews: [] // clear existing previews, they will be regenerated in useEffect
    });
  };
      ...
      >
        ...
        <motion.div className="flex justify-between mt-8">
          ...
          <motion.button
            ...
            type="submit"
            disabled={
              (step === 1 && (!formData.companyName || !formData.contactNumber || !formData.email || !formData.password || !formData.confirmPassword)) ||
